...
wax.mm.share = function(map, tilejson) {
    tilejson = tilejson || {};
    tilejson.webpage = tilejson.webpage || window.location.toString().split('#')[0];
    tilejson.embed = tilejson.embed || window.location.toString().split('#')[0] + '#embed';
    ...
    var twitter = 'http://twitter.com/intent/tweet?status='
        + encodeURIComponent(tilejson.name + ' (' + tilejson.webpage + ')');
