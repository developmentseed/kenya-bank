...
#sec_exam_change {
 ...
 [zoom >= 11]{polygon-opacity:0;}
  ...
  [percent_change_0610 >= 6][percent_change_0610 <= 10]{
    polygon-fill:@m3;line-color:darken(@m3,10);
    }
  [percent_change_0610 >= 3][percent_change_0610 < 6]{
    polygon-fill:@m2;line-color:darken(@m2,10);
    }
  [percent_change_0610 >= 0][percent_change_0610 < 3]{
    polygon-fill:@m1;line-color:darken(@m1,10); 
   }
  [percent_change_0610 < 0][percent_change_0610 > -10]{
    polygon-fill:@b3;line-color:darken(@b3,10);  
  }
  [percent_change_0610 <= -10]{
